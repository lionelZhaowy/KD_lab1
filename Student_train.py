...
with open(file_path,"w") as f:
    ...
    f.write("训练结束，最优精度:{}\n".format(max_acc))
    torch.save(best_model,'D:/Anaconda3/program_files/KD_lab/models/Student.pth')

x = list(range(epochs))
#绘制精度折线
plt.xlabel("epoch")
plt.ylabel("acc")
plt.title("Student:acc_train-epoch")
